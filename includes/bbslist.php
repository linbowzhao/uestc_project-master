...
<div class="container">
    <div class="row">
        <div class="col-md-7">
            <div class="header">
                <a href="#">全部</a><a href="#">精华</a><a href="bbsedit.php" id="editA">发帖</a>
            </div>
            <?php  
			...
			{    
				...
				{    
					...
					$sql = "select * from bbspage order by time desc limit $startnum,$perpagenum";//查询出所需要的条数
					$rs = mysql_query($sql);
            ...
            ?>
                <div class="title">
                    <h4 style="margin-left:50px;"><a href="bbspage.php?pid=<?php echo $pid;?>"><?php echo $title;?></a></h4><!--这是标题-->
                    <ul>
                ...
                <?php
					...
					$per = $page - 1;//上一页    
					$next = $page + 1;//下一页    
					echo "<p style='text-align: center;'>共有".$Total."篇文章";
					if($page != 1)    
					{    
					...
					echo "<a href='".$_SERVER['PHP_SELF'].'?page='.$Totalpage."'> 尾页</a></p>";
					}    
					}    
