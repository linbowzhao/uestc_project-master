...
<div class="container">
    <div class="row">
        <div class="col-md-7">
            <div class="header">
                <a href="bbslist.php">全部</a><a href="bbslist.php?i=1">精华</a><a href="bbsedit.php" id="editA">发帖</a>
            </div>
            <?php  
			...
			if(!isset($_GET['page'])||!intval($_GET['page'])||$_GET['page']>$Totalpage)//page可能的四种状态
			{
				...
				else
				{
                    ...
                    if(isset($_GET['i'])&& $_GET['i']==1){
                        $sql = "select * from bbspage where importance=1 order by time desc limit $startnum,$perpagenum";//查询出所需要的加精条数
                        $i=1;
                    }else{
